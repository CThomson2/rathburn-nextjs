...
function Button({ visible, disabled, ...props }: any) {
  return (
    <button
      className={
        visible ? `ti-btn ti-btn-primary-full text-white` : "invisible"
      }
      {...props}
    />
  );
              ...
              <div className="xl:col-span-6 col-span-12">
                <div className="form-floating">
                  <input
                    ...
                    className="form-control  w-full !rounded-md"
                    id="email-add"
                    defaultValue="jsonThomson2413@gmail.com"
          ...
          <div className="p-[3rem] checkout-payment-success my-3">
            ...
            <div className="mb-6">
              <p className="mb-1 text-[0.875rem]">
                ...
                <Link className="link-success" href="#!" scroll={false}>
