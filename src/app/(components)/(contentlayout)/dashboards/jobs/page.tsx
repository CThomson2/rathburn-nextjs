              ...
              <div className="box overflow-hidden">
                ...
                <div className="box-body !p-0">
                  ...
                  <div id="subscriptionOverview" className="px-3 sm:mt-0 mt-3">
                    <ReactApexChart
                      options={Jobsdata.Subscriptions.options}
                      series={Jobsdata.Subscriptions.series}
                      type="line"
                      width={"100%"}
                      height={293}
                    />
              ...
              <div className="box overflow-hidden">
                ...
                <div className="box-body !p-0">
                  <div id="candidates-chart" className="p-3">
                    <ReactApexChart
                      options={Jobsdata.Candidatesdata.options}
                      series={Jobsdata.Candidatesdata.series}
                      type="donut"
                      width={"100%"}
                      height={250}
                    />
