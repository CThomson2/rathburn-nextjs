          ...
          <div className="box">
            <div className="box-body">
              ...
              <div id="nft-balance-chart" className="px-4 py-6">
                <ReactApexChart
                  options={Nftdata.Totalbalance.options}
                  series={Nftdata.Totalbalance.series}
                  type="line"
                  width={"100%"}
                  height={40}
                />
          ...
          <div className="box">
            ...
            <div className="box-body !p-0">
              ...
              <div id="nft-statistics" className="p-3">
                <ReactApexChart
                  options={Nftdata.NFTStatistics.options}
                  series={Nftdata.NFTStatistics.series}
                  type="line"
                  width={"100%"}
                  height={336}
                />
                      ...
                      >
                        <td className="">
                          <div className="flex items-center">
                            ...
                            <div>
                              <p className="mb-0 font-semibold">
                                <Link href="#!" scroll={false} title="nft_name">
                                  {idx.name}
                                </Link>
                              </p>
                              <Link
