                      ...
                      <div className="flex gap-3 flex-wrap items-start justify-between">
                        ...
                        <div>
                          <div id="total-invested">
                            <ReactApexChart
                              options={Stocksdata.TotalInvested.options}
                              series={Stocksdata.TotalInvested.series}
                              type="line"
                              height={40}
                              width={100}
                            />
                      ...
                      <div className="flex gap-3 flex-wrap items-start justify-between">
                        ...
                        <div>
                          <div id="total-investments">
                            <ReactApexChart
                              options={Stocksdata.NumberofInvested.options}
                              series={Stocksdata.NumberofInvested.series}
                              type="line"
                              height={40}
                              width={100}
                            />
                      ...
                      <div className="flex gap-3 flex-wrap items-start justify-between">
                        ...
                        <div>
                          <div id="portfolio-value">
                            <ReactApexChart
                              options={Stocksdata.Portfoliovalue.options}
                              series={Stocksdata.Portfoliovalue.series}
                              type="line"
                              height={40}
                              width={100}
                            />
                    ...
                    <div className="box-body">
                      <div className="flex gap-3 flex-wrap items-start justify-between">
                        ...
                        <div>
                          <div id="returns-rate">
                            <ReactApexChart
                              options={Stocksdata.Returnsrate.options}
                              series={Stocksdata.Returnsrate.series}
                              type="line"
                              height={40}
                              width={100}
                            />
                  ...
                  <div className="box">
                    ...
                    <div className="box-body">
                      ...
                      <div id="totalInvestmentsStats">
                        <ReactApexChart
                          options={Stocksdata.Totalinvestments.options}
                          series={Stocksdata.Totalinvestments.series}
                          type="area"
                          width={"100%"}
                          height={320}
                        />
                        ...
                        <div className="xl:col-span-7 col-span-12 border-e dark:border-defaultborder/10">
                          <div className="p-4">
                            ...
                            <div id="stocks-marketcap">
                              <ReactApexChart
                                options={Stocksdata.MarketCap.options}
                                series={Stocksdata.MarketCap.series}
                                type="candlestick"
                                width={"100%"}
                                height={350}
                              />
