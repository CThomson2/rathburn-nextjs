                    ...
                    <div className="box-body flex justify-between items-center">
                      <div>
                        ...
                        <span className="badge bg-success/10 text-success">
                          1.5% <i className="ti ti-trending-up ms-1"></i>
                        </span>
                    ...
                    <div className="box-body flex justify-between items-center">
                      <div>
                        ...
                        <span className="badge bg-danger/10 text-danger">
                          0.23% <i className="ti ti-trending-down ms-1"></i>
                        </span>
                        <span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] ms-1">
                          this month
                        </span>
                  ...
                  <div className="box">
                    <div className="box-body flex justify-between items-center">
                      <div>
                        ...
                        <span className="badge bg-success/10 text-success">
                          0.67% <i className="ti ti-trending-up ms-1"></i>
                        </span>
                        <span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] ms-1">
                          this month
                        </span>
                  ...
                  <div className="box">
                    <div className="box-body flex justify-between items-center">
                      <div>
                        ...
                        <span className="badge bg-success/10 text-success">
                          0.53% <i className="ti ti-trending-up ms-1"></i>
                        </span>
                        <span className="text-[#8c9097] dark:text-white/50 text-[0.6875rem] ms-1">
                          this month
                        </span>
                  ...
                  <div className="box">
                    ...
                    <div className="box-body">
                      <div id="projectAnalysis">
                        <ReactApexChart
                          options={Projectdata.ProjectAnalysis.options}
                          series={Projectdata.ProjectAnalysis.series}
                          type="line"
                          width={"100%"}
                          height={315}
                        />
                        ...
                        <li>
                          <Link href="#!" scroll={false}>
                            <div className="flex items-center justify-between">
                              ...
                              <div id="user1">
                                <ReactApexChart
                                  options={Projectdata.Team1.options}
                                  series={Projectdata.Team1.series}
                                  type="line"
                                  height={20}
                                  width={80}
                                />
                        ...
                        <li>
                          <Link href="#!" scroll={false}>
                            <div className="flex items-center justify-between">
                              ...
                              <div id="user2">
                                <ReactApexChart
                                  options={Projectdata.Team2.options}
                                  series={Projectdata.Team2.series}
                                  type="line"
                                  height={20}
                                  width={80}
                                />
                        ...
                        <li>
                          <Link href="#!" scroll={false}>
                            <div className="flex items-center justify-between">
                              ...
                              <div id="user3">
                                <ReactApexChart
                                  options={Projectdata.Team3.options}
                                  series={Projectdata.Team3.series}
                                  type="line"
                                  height={20}
                                  width={80}
                                />
                        ...
                        <li>
                          <Link href="#!" scroll={false}>
                            <div className="flex items-center justify-between">
                              ...
                              <div id="user4">
                                <ReactApexChart
                                  options={Projectdata.Team4.options}
                                  series={Projectdata.Team4.series}
                                  type="line"
                                  height={20}
                                  width={80}
                                />
                        ...
                        <li>
                          <Link href="#!" scroll={false}>
                            <div className="flex items-center justify-between">
                              ...
                              <div id="user5">
                                <ReactApexChart
                                  options={Projectdata.Team5.options}
                                  series={Projectdata.Team5.series}
                                  type="line"
                                  height={20}
                                  width={80}
                                />
                        ...
                        <div className="box-body">
                          <p className="text-[0.875rem] font-semibold mb-2 leadining-none">
                            ...
                            <Link aria-label="anchor" href="#!" scroll={false}>
                              <i className="bi bi-plus-square ltr:float-right rtl:float-left text-primary ms-2 text-[1.125rem]"></i>
                            </Link>
                          </p>
                      ...
                      <div className="box border border-warning/25 shadow-none custom-card">
                        <div className="box-body">
                          <p className="text-[0.875rem] font-semibold mb-2 leadining-none">
                            ...
                            <Link aria-label="anchor" href="#!" scroll={false}>
                              <i className="bi bi-plus-square ltr:float-right rtl:float-left text-warning ms-2  text-[1.125rem]"></i>
                            </Link>
                          </p>
                          <div className="flex flex-wrap gap-2 mb-4">
                      ...
                      <div className="box border border-success/25 shadow-none custom-card">
                        <div className="box-body">
                          <p className="text-[0.875rem] font-semibold mb-2 leadining-none">
                            About Us Page redesign
                            <Link aria-label="anchor" href="#!" scroll={false}>
                              <i className="bi bi-plus-square ltr:float-right rtl:float-left text-success ms-2 text-[1.125rem]"></i>
                            </Link>
                          </p>
                          <div className="flex flex-wrap gap-2 mb-4">
                            <span className="badge text-danger bg-danger/10">
                      ...
                      <div className="box border border-secondary/25 shadow-none custom-card !mb-0">
                        <div className="box-body">
                          <p className="text-[0.875rem] font-semibold mb-2 leadining-none">
                            ...
                            <Link aria-label="anchor" href="#!" scroll={false}>
                              <i className="bi bi-plus-square ltr:float-right rtl:float-left text-secondary ms-2 text-[1.125rem]"></i>
                            </Link>
                          </p>
                          <div className="flex flex-wrap gap-2 mb-4">
                            <span className="badge text-info bg-info/10">
