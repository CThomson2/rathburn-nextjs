          ...
          <div className="box">
            ...
            <div className="box-body">
              <div id="performanceReport">
                <ReactApexChart
                  options={Hrmdata.Performancebycategory.options}
                  series={Hrmdata.Performancebycategory.series}
                  type="bar"
                  width={"100%"}
                  height={310}
                />
        ...
        <div className="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-12 col-span-12">
          <div className="box">
            ...
            <div className="box-body !p-6">
              <div id="jobs-summary">
                <ReactApexChart
                  options={Hrmdata.JobsSummary.options}
                  series={Hrmdata.JobsSummary.series}
                  type="donut"
                  width={"100%"}
                  height={247}
                />
