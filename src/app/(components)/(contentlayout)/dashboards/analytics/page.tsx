    ...
    <Fragment>
                ...
                <div className="box-body">
                  <div className="flex flex-wrap items-center justify-between">
                    <div>
                      ...
                      <span className="block text-success text-[0.75rem]">
                        +0.892 <i className="ti ti-trending-up ms-1"></i>
                      </span>
                    </div>
                ...
                <div className="box-body">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <span className="block text-danger text-[0.75rem]">
                        +0.59
                        <i className="ti ti-trending-down ms-1 inline-flex"></i>
                      </span>
                    </div>
                    <div>
              ...
              <div className="box custom-card upgrade-card text-white">
                <div className="box-body text-white">
                  ...
                  <div className="upgrade-card-content">
                    <span className="opacity-[0.7] font-normal mb-1 !text-white">
                      Plan is expiring !
                    </span>
                    <span className="text-[0.9375rem] font-semibold block mb-[3rem] upgrade-text !text-white">
                      Upgrade to premium
                    </span>
                    <button
                      type="button"
                ...
                <div className="box-body !p-1">
                  <div className="flex items-center flex-wrap">
                    <div id="analytics-followers">
                      <ReactApexChart
                        options={Analyticsdata.Impressions.options}
                        series={Analyticsdata.Impressions.series}
                        type="radialBar"
                        width={100}
                        height={120}
                      />
                ...
                <div className="box-body !p-1">
                  <div className="flex items-center flex-wrap">
                    <div id="analytics-views">
                      <ReactApexChart
                        options={Analyticsdata.Clicks.options}
                        series={Analyticsdata.Clicks.series}
                        type="radialBar"
                        width={100}
                        height={120}
                      />
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="xl:col-span-9 col-span-12">
          <div className="box">
            <div className="box-header justify-between">
              <div className="box-title">Visitors By Channel Report</div>
