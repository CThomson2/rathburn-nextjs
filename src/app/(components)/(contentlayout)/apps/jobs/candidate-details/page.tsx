              ...
              <div className="box-body !p-0 candidate-edu-timeline">
                <div className="p-6 border-b dark:border-defaultborder/10">
                  <h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2 mb-4">
                    <span className="avatar !rounded-full bg-primary avatar-sm">
                      <i className="bi bi-briefcase text-[.8125rem] text-white"></i>
                    </span>{" "}
                    Career Objective :
                  </h5>
                ...
                <div className="p-6 border-b dark:border-defaultborder/10">
                  <h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
                    <span className="avatar !rounded-full bg-primary avatar-sm">
                      <i className="bi bi-mortarboard text-[.8125rem] text-white"></i>
                    </span>{" "}
                    Education :
                  </h5>
                  <div className="ms-6 ps-4">
                ...
                <div className="p-6 border-b dark:border-defaultborder/10">
                  <h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
                    <span className="avatar !rounded-full bg-primary avatar-sm">
                      <i className="bi bi-award text-[.8125rem] text-white"></i>
                    </span>{" "}
                    Certifications :
                  </h5>
                  <div className="ms-6 ps-4">
                ...
                <div className="p-6 border-b dark:border-defaultborder/10">
                  <h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
                    <span className="avatar !rounded-full bg-primary avatar-sm">
                      <i className="bi bi-journal-medical text-[.8125rem] text-white"></i>
                    </span>{" "}
                    Publications :
                  </h5>
                  <div className="ms-4">
                ...
                <div className="p-6 border-b dark:border-defaultborder/10">
                  <h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
                    <span className="avatar !rounded-full bg-primary avatar-sm">
                      <i className="bi bi-activity text-[.8125rem] text-white"></i>
                    </span>{" "}
                ...
                <div className="p-6 border-b dark:border-defaultborder/10">
                  <h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2">
                    <span className="avatar !rounded-full bg-primary avatar-sm">
                      <i className="bi bi-link-45deg text-[.8125rem] text-white"></i>
                    </span>{" "}
                    References :
                  </h5>
                  <div className="ms-6 ps-4">
            ...
            <div className="box custom-box">
              ...
              <div className="box-body !p-0 candidate-edu-timeline">
                ...
                <div className="p-6">
                  <h5 className="font-semibold text-[1.0625rem] sm:flex items-center gap-2 mb-4">
                    <span className="avatar !rounded-full bg-primary avatar-sm">
                      <i className="bi bi-people text-[.8125rem] text-white"></i>
                    </span>{" "}
