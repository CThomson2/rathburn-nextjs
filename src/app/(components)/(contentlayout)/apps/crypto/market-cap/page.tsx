              ...
              <div className="sm:flex items-center mb-4">
                ...
                <div className="ms-auto">
                  <div id="bitcoin-chart">
                    <ReactApexChart
                      options={Marketcapdata.CapBTC.options}
                      series={Marketcapdata.CapBTC.series}
                      type="line"
                      height={35}
                      width={120}
                    />
              ...
              <div className="sm:flex items-center mb-4">
                ...
                <div className="ms-auto">
                  <div id="etherium-chart">
                    <ReactApexChart
                      options={Marketcapdata.CapETH.options}
                      series={Marketcapdata.CapETH.series}
                      type="line"
                      height={35}
                      width={120}
                    />
              ...
              <div className="sm:flex items-center mb-4">
                ...
                <div className="ms-auto">
                  <div id="dashcoin-chart">
                    <ReactApexChart
                      options={Marketcapdata.CapDASH.options}
                      series={Marketcapdata.CapDASH.series}
                      type="line"
                      height={35}
                      width={120}
                    />
                  ...
                  <tbody>
                    <tr className="border border-defaultborder">
                      ...
                      <td>
                        <div id="btc-chart">
                          <ReactApexChart
                            options={Marketcapdata.CapBitcoin.options}
                            series={Marketcapdata.CapBitcoin.series}
                            type="line"
                            height={35}
                            width={120}
                          />
                    ...
                    <tr className="border border-defaultborder">
                      ...
                      <td>
                        <div id="eth-chart">
                          <ReactApexChart
                            options={Marketcapdata.CapEtherium.options}
                            series={Marketcapdata.CapEtherium.series}
                            type="line"
                            height={35}
                            width={120}
                          />
