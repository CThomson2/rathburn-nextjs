...
const Formswitch = () => {
  return (
    <>
      ...
      <Pageheader
        currentpage="Form switch"
        activepage="Form Elements"
        mainpage="Form switch"
      />
          ...
          <Showcode title="Toggle Switch With Tooltip" code={switch2}>
            <div className="hs-tooltip flex items-center">
              <input
                ...
                className="hs-tooltip-toggle ti-switch shrink-0"
              />
              <label
                htmlFor="hs-tooltip-example"
                className="text-sm text-gray-500 ms-3 dark:text-white/70"
              >
        ...
        <div className="col-span-12 lg:col-span-6">
          <Showcode title="Toggle Switch With Description" code={switch3}>
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <label className="text-sm text-gray-500 me-3 dark:text-white/70">
                  On
                </label>
                <input
                  type="checkbox"
                  ...
                  className="ti-switch"
                />
                <label className="text-sm text-gray-500 ms-3 dark:text-white/70">
                  Off
                </label>
              </div>
            </div>
          ...
          <Showcode title="Disabled Toggle Switch" code={switch4}>
            <div className="space-y-4">
              <div className="flex items-center opacity-70">
                <input
                  type="checkbox"
                  id="hs-basic-disabled-with-description-unchecked"
                  className="ti-switch shrink-0 pointer-events-none"
                  disabled
                />
                <label
                  htmlFor="hs-basic-disabled-with-description-unchecked"
                  className="text-sm text-gray-500 ms-3 dark:text-white/70"
                >
                  Unchecked
                </label>
              ...
              <div className="flex items-center opacity-70">
                <input
                  type="checkbox"
                  id="hs-basic-disabled-with-description-checked"
                  className="ti-switch shrink-0 pointer-events-none"
                  defaultChecked
                  disabled
                />
                <label
                  htmlFor="hs-basic-disabled-with-description-checked"
                  className="text-sm text-gray-500 ms-3 dark:text-white/70"
                >
                  Checked
                </label>
              ...
              <div className="flex items-center opacity-70">
                ...
                <input
                  type="checkbox"
                  id="hs-basic-disabled-with-description"
                  className="ti-switch shrink-0 pointer-events-none"
                  disabled
                />
                <label className="text-sm text-gray-500 ms-3 dark:text-white/70">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <input
                  ...
                  className="ti-switch shrink-0 checked:bg-none checked:bg-green-600 checked:hover:bg-green-600 checked:focus:bg-green-600 focus:border-green-600 focus:ring-green-600 dark:checked:bg-green-600
              ...
              <div className="flex items-center">
                <input
                  type="checkbox"
                  id="hs-invalid-toggle-switch"
                  className="ti-switch shrink-0 checked:bg-none checked:bg-red-600 checked:hover:bg-red-600 
                    checked:focus:bg-red-600 focus:border-red-600 focus:ring-red-600 dark:checked:bg-red-600
  
                                  checked:before:bg-red-200 dark:checked:before:bg-red-200"
                  defaultChecked
                />
                <label
                  htmlFor="hs-invalid-toggle-switch"
                  className="text-sm text-gray-500 ms-3 dark:text-white/70"
                >
                  Invalid toggle switch
                </label>
              </div>
            </div>
          </Showcode>
          ...
          <Showcode title="Solid Color Variants" code={switch7}>
            <div className="space-x-4 rtl:space-x-reverse">
              <div className="relative inline-block">
                <input
                  type="checkbox"
                  id="hs-xs-solid-switch"
                  className="ti-switch shrink-0 !w-[35px] !h-[21px] before:size-4"
                />
                <label htmlFor="hs-xs-solid-switch" className="sr-only">
                  Extra small
                </label>
              </div>
              ...
              <div className="relative inline-block">
                <input
                  ...
                  className="ti-switch shrink-0 !w-11 !h-6 before:size-5"
                />
                <label htmlFor="hs-small-solid-switch" className="sr-only">
                  Small
                </label>
              </div>
              ...
              <div className="relative inline-block">
                <input
                  type="checkbox"
                  id="hs-medium-solid-switch"
                  className="ti-switch shrink-0"
                />
                <label htmlFor="hs-medium-solid-switch" className="sr-only">
                  Medium
                </label>
              </div>
              ...
              <div className="relative inline-block">
                <input
                  type="checkbox"
                  id="hs-large-solid-switch"
                  className="ti-switch shrink-0 !w-[4.25rem] !h-9 before:w-8 before:h-8"
                />
                <label htmlFor="hs-large-solid-switch" className="sr-only">
                  Large
                </label>
              </div>
            </div>
          ...
          <Showcode title="Solid Color With Icons" code={switch8}>
            <div className="space-x-4 rtl:space-x-reverse">
              <div className="relative inline-block">
                <input
                  type="checkbox"
                  id="hs-small-solid-switch-with-icons"
                ...
                />
                <label
                  htmlFor="hs-small-solid-switch-with-icons"
                  className="sr-only"
                >
                  switch
                </label>
              ...
              <div className="relative inline-block">
                ...
                />
                <label
                  htmlFor="hs-default-solid-switch-with-icons"
                  className="sr-only"
                >
                  switch
                </label>
              ...
              <div className="relative inline-block">
                <input
                  type="checkbox"
                  id="hs-large-solid-switch-with-icons"
                ...
                />
                <label
                  htmlFor="hs-large-solid-switch-with-icons"
                  className="sr-only"
                >
                  switch
                </label>
          ...
          <Showcode title="Soft Color Variants" code={switch9}>
            <div className="space-x-4 rtl:space-x-reverse">
              <div className="relative inline-block">
                ...
                />
                <label htmlFor="hs-xs-soft-switch" className="sr-only">
                  Extra small
                </label>
              </div>
              ...
              <div className="relative inline-block">
                ...
                />
                <label htmlFor="hs-small-soft-switch" className="sr-only">
                  Small
                </label>
              </div>
              ...
              <div className="relative inline-block">
                ...
                />
                <label htmlFor="hs-medium-soft-switch" className="sr-only">
                  Medium
                </label>
              </div>
              ...
              <div className="relative inline-block">
                ...
                />
                <label htmlFor="hs-large-soft-switch" className="sr-only">
                  Large
                </label>
              </div>
            </div>
          ...
          <Showcode title="Soft Color With Icons" code={switch10}>
            <div className="space-x-4 rtl:space-x-reverse">
              <div className="relative inline-block">
                <input
                  type="checkbox"
                  id="hs-small-switch-soft-with-icons"
                ...
                />
                <label
                  htmlFor="hs-small-switch-soft-with-icons"
                  className="sr-only"
                >
                  switch
                </label>
              ...
              <div className="relative inline-block">
                <input
                  type="checkbox"
                  id="hs-default-switch-soft-with-icons"
                ...
                />
                <label
                  htmlFor="hs-default-switch-soft-with-icons"
                  className="sr-only"
                >
                  switch
                </label>
