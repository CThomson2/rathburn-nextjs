...
const Advancedselect = () => {
  ...
  useEffect(() => {
    const handleDynamicOptions = () => {
      setTimeout(() => {
        ...
        const addOptionsBtn = document.querySelector(
          "#add-options"
        ) as HTMLButtonElement;
        const removeOptionBtn = document.querySelector(
          "#remove-option"
        ) as HTMLButtonElement;
        const removeOptionsBtn = document.querySelector(
          "#remove-options"
        ) as HTMLButtonElement;
        const select = (window as any).HSSelect.getInstance(
          "#hs-select-with-dynamic-options"
        );
    ...
    return () => {
      window.removeEventListener("load", () =>
        requestAnimationFrame(handleDynamicOptions)
      );
    };
  }, []); // Empty dependency array to run only once on component mount
  ...
  return (
    <>
      ...
      <Pageheader
        currentpage="Advanced Select"
        activepage="Form Elements"
        mainpage="Advanced Select"
      />
      ...
      <div className="grid grid-cols-12 gap-x-6">
          ...
          <Showcode title="Basic Select" code={advanvcedselect1}>
            <div className="relative">
              ...
              <div className="absolute top-1/2 end-3 -translate-y-1/2">
                <svg
                  className="flex-shrink-0 size-3.5 text-gray-500 dark:text-white/70"
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Multiple Select with counter"
            code={advanvcedselect4}
          >
            <div className="relative">
              <select
                multiple
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Select Search inside dropdown"
            code={advanvcedselect5}
          >
            <select
              data-hs-select='{
                                "hasSearch": true,
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Select Custom template with icons"
            code={advanvcedselect7}
          >
            <div className="relative">
              <select
                data-hs-select='{
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Select Custom template with avatars"
            code={advanvcedselect8}
          >
            <div className="relative">
              <select
                data-hs-select='{
      ...
      <div className="grid grid-cols-12 gap-x-6">
            ...
            <div>
              <div className="relative">
                ...
                <div className="absolute top-1/2 end-8 -translate-y-1/2">
                  <svg
                    className="flex-shrink-0 size-4 text-danger"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div>
              <div className="relative">
                ...
                <div className="absolute inset-y-0 end-8 flex items-center pointer-events-none">
                  <svg
                    className="flex-shrink-0 size-4 text-success"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div className="space-y-3">
              <div id="validation-target" className="mb-4">
                <div className="relative">
                  ...
                  <div className="hidden hs-success:flex absolute inset-y-0 end-8 items-center pointer-events-none">
                    <svg
                      className="flex-shrink-0 size-4 text-success"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <p className="hidden hs-error:block text-sm text-danger mt-2">
                  Please select a valid state.
                </p>
                <p className="hidden hs-success:flex text-sm text-success mt-2">
                  Looks good!
                </p>
              </div>
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Select Validation states"
            code={advanvcedselect13}
            customCardBodyClass=""
          >
            <div className="max-w-sm space-y-3">
              <div className="relative">
                <select
                  id="hs-select-with-dynamic-options"
                  data-hs-select='{
                                            "placeholder": "Select assignee",
                                            "toggleTag": "<button type=\"button\"><span class=\"me-2\" data-icon></span><span class=\"text-gray-800 dark:text-gray-200\" data-title></span></button>",
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Destroy/Reinitialize Select"
            code={advanvcedselect14}
            customCardBodyClass=""
          >
            <div className="max-w-sm space-y-3">
              <div className="relative">
                ...
                <div
                  id="hs-select-temporary-toggle-icon"
