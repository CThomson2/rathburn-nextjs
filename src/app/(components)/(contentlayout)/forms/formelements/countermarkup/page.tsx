...
const Countermarkup = () => {
  useEffect(() => {
    const handleLoad = () => {
      const copyContent = (window as any).HSCopyMarkup.getInstance(
        "#hs-copy-select-content"
      );
      if (copyContent) {
  ...
  return (
    <>
      ...
      <Pageheader
        currentpage="Counters & Markup"
        activepage="Form Elements"
        mainpage="Counters & Markup"
      />
        ...
        <div className="col-span-12 xxl:col-span-6">
          <Showcode title="Checkbox Toggle Count" code={counter1}>
            <div className="flex justify-end mb-3">
              <div
                id="toggle-count"
                className="p-0.5 inline-block bg-gray-100 rounded-sm dark:bg-bodybg2 space-x-1"
              >
                <label
                ...
                >
                  ...
                  <input
                    ...
                    name="toggle-count"
                    type="radio"
                    className="absolute top-0 end-0 size-full border-transparent bg-transparent dark:bg-bodybg bg-none text-transparent rounded-sm cursor-pointer before:absolute before:inset-0 before:size-full before:rounded-sm focus:ring-offset-0 checked:before:bg-white checked:before:shadow-sm checked:bg-none focus:ring-transparent dark:checked:before:bg-bodybg dark:focus:ring-offset-transparent"
                  />
                </label>
                <label
                  htmlFor="toggle-count-annual"
                  className="relative inline-block py-2 px-3 dark:bg-bodybg2"
                >
                  <span className="inline-block relative z-10 text-sm font-medium text-gray-800 cursor-pointer dark:text-gray-200">
                    Annual
                  </span>
                  <input
                    ...
                    name="toggle-count"
                    type="radio"
                    className="absolute top-0 end-0 size-full border-transparent bg-transparent bg-none text-transparent rounded-sm cursor-pointer before:absolute before:inset-0 before:size-full before:rounded-sm focus:ring-offset-0 checked:before:bg-white checked:before:shadow-sm checked:bg-none focus:ring-transparent dark:checked:before:bg-bodybg2 dark:focus:ring-offset-transparent"
                    defaultChecked
                  />
                </label>
              </div>
            ...
            <div className="grid sm:grid-cols-3 lg:items-center border border-gray-200 rounded-sm dark:border-white/10">
              <div className="flex flex-col p-4">
                ...
                <div className="flex gap-x-1">
                  <span className="text-xl font-normal text-gray-800 dark:text-white">
                    $
                  </span>
                  <p
              ...
              <div className="flex flex-col p-4">
                <div className="flex justify-between">
                  <h4 className="text-gray-800 mb-1 dark:text-gray-200">
                    Team
                  </h4>
                </div>
                <div className="flex gap-x-1">
        ...
        <div className="col-span-12 xxl:col-span-6">
          <Showcode title="Switch Toggle Count" code={counter2}>
            ...
            <div className="grid sm:grid-cols-3 lg:items-center border border-gray-200 rounded-sm dark:border-white/10">
              ...
              <div className="flex flex-col p-4">
                <h4 className="text-gray-800 mb-1 dark:text-white">
                  Enterprise
                </h4>
                <div className="flex gap-x-1">
                  <span className="text-xl font-normal text-gray-800 dark:text-white">
