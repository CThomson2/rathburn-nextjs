    ...
    <>
      ...
      <div className="grid grid-cols-12 gap-x-6">
          ...
          <Showcode title="Strong Password with API" code={password2}>
            <div className="flex">
              <div className="relative flex-1">
                ...
                >
                  <div
                    id="hs-strong-password-api-in-popover"
                    data-hs-strong-password='{
        ...
        <div className="col-span-12 lg:col-span-4">
          ...
          <Showcode
            title="Strong Password Working with Popover"
            code={password4}
          >
            <div className="flex">
              <div className="relative flex-1">
        ...
        <div className="col-span-12 lg:col-span-4">
          <Showcode
            title="Strong Password With Indicator and Hints"
            code={password5}
          >
        ...
        <div className="col-span-12 lg:col-span-4">
          <Showcode title=" Basic Toggle Password" code={password6}>
            ...
            <div className="relative">
              ...
              >
                <svg
                  className="flex-shrink-0 size-3.5 text-gray-400 dark:text-white"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  fill="none"
          ...
          <Showcode title="Checkbox Tooggle Password" code={password7}>
            <div className="max-w-sm mb-5">
              ...
              <input
                ...
                type="password"
                className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-primary focus:ring-primary disabled:opacity-50 disabled:pointer-events-none dark:!bg-light dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
              ...
              <div className="flex mt-4">
                <input
                  ...
                  type="checkbox"
                  className="shrink-0 mt-0.5 border-gray-200 rounded text-primary focus:ring-primary dark:bg-light dark:border-neutral-700 dark:checked:bg-primary dark:checked:border-primary dark:focus:ring-offset-gray-800"
                />
                <label
      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="col-span-12 xl:col-span-3 lg:col-span-6">
          <Showcode title="PIN Input Regex type" code={password15}>
            <div
              className="flex space-x-3 rtl:space-x-reverse"
              data-hs-pin-input='{"availableCharsRE": "^[0-3]+$"}'
            >
              <input
                type="text"
                className="dark:placeholder:text-white/50 block w-[38px] text-center border-gray-200 rounded-md text-sm [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none focus:border-primary focus:ring-primary disabled:opacity-50 disabled:pointer-events-none dark:bg-bodybg dark:border-white/10 dark:text-white dark:focus:ring-primary"
        ...
        <div className="col-span-12  lg:col-span-6">
          <Showcode
            title="Show PIN code suggest on iOS keyboard"
            code={password17}
          >
            <div
              className="flex space-x-3 rtl:space-x-reverse"
