      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode title="Buttons vertically stacked" code={inputnumber2}>
            <div
              className="bg-white border border-gray-200 rounded-sm dark:bg-bodybg dark:border-white/10"
              data-hs-input-number
            >
          ...
          <Showcode title="Buttons horizontally stacked" code={inputnumber3}>
            ...
            >
              <div className="w-full flex justify-between items-center gap-x-1 overflow-hidden">
                ...
                <div className="flex items-center -gap-y-px divide-x divide-gray-200 border-s border-gray-200 dark:divide-white/10 dark:border-white/10">
                  <button
                    type="button"
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode title="Mini Input" code={inputnumber4}>
            <div
              className="py-2 px-3 inline-block bg-white border border-gray-200 rounded-sm dark:bg-bodybg dark:border-white/10"
              data-hs-input-number
            >
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode title="Pricing seats example" code={inputnumber5}>
            <div
              className="py-2 px-3 bg-white border border-gray-200 rounded-sm dark:bg-bodybg dark:border-white/10"
              data-hs-input-number
            >
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode title="Validation states" code={inputnumber8}>
            <div
              className="py-2 px-3 bg-white border border-danger rounded-sm dark:bg-bodybg"
              data-hs-input-number
            >
              <div className="w-full flex justify-between items-center gap-x-3">
