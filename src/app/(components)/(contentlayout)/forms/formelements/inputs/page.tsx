      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode title="Inputs With Placeholder" code={input6}>
            <div className="max-w-sm space-y-3">
              ...
              />
              <textarea
                className="py-3 px-4 ti-form-input"
                rows={2}
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode title="Disabled Inputs" code={input7}>
            <div className="max-w-sm space-y-3">
              <input
                type="text"
                className="opacity-70 pointer-events-none ti-form-input"
                placeholder="Disabled input"
                disabled
              />
              <input
              ...
              />
              <textarea
                className="py-3 px-4 ti-form-input disabled:opacity-50 disabled:pointer-events-none"
                rows={2}
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Gray Inputs"
            code={input8}
            customCardBodyClass="space-y-3"
          >
            <div className="relative">
              <input
                type="email"
                className="peer py-3 px-4 ps-11 ti-form-input bg-gray-100 border-transparent disabled:opacity-50 disabled:pointer-events-none rounded dark:bg-bodybg2 dark:border-transparent"
                placeholder="Enter name"
              />
              <div className="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4 peer-disabled:opacity-50 peer-disabled:pointer-events-none">
                <svg
                  className="flex-shrink-0 size-4 text-gray-500 dark:text-white/50"
            ...
            <textarea
              className="py-3 px-4 ti-form-input bg-gray-100 border-transparent disabled:opacity-50 disabled:pointer-events-none rounded dark:bg-bodybg2 dark:border-transparent"
              rows={3}
              placeholder="This is a textarea placeholder"
            ></textarea>
          </Showcode>
          ...
          >
            <div className="relative">
              <input
                ...
                className="peer p-4 ti-form-input placeholder:!text-transparent focus:!border-primary focus:!ring-primary disabled:opacity-50 disabled:pointer-events-none focus:pt-6 focus:pb-2 [&:not(:placeholder-shown)]:pt-6 [&:not(:placeholder-shown)]:pb-2 autofill:pt-6 autofill:pb-2"
              ...
              <label
                ...
                className="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                    ...
                                    peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-white/70"
              >
                Email
              </label>
            </div>
            <div className="relative">
              <input
                ...
                className="peer p-4 ti-form-input placeholder:!text-transparent focus:!border-primary focus:!ring-primary disabled:opacity-50 disabled:pointer-events-none
                                    focus:pt-6
                                    focus:pb-2
            ...
            <div className="relative">
              <textarea
                ...
                className="peer p-4 ti-form-input placeholder:!text-transparent focus:!border-primary focus:!ring-primary disabled:opacity-50 disabled:pointer-events-non
                                    focus:pt-6
                                    focus:pb-2
                                    [&:not(:placeholder-shown)]:pt-6
                                    [&:not(:placeholder-shown)]:pb-2
          ...
          >
            <div className="relative">
              <input
                ...
                className="peer p-4 ti-form-input bg-gray-100 border-transparent placeholder:!text-transparent focus:border-primary focus:ring-primary disabled:opacity-50 disabled:pointer-events-none dark:bg-bodybg2 rounded-md dark:border-transparent
                                    focus:pt-6
                                    focus:pb-2
                                    [&:not(:placeholder-shown)]:pt-6
                                    [&:not(:placeholder-shown)]:pb-2
            ...
            <div className="relative">
              <input
                ...
                className="peer p-4 ti-form-input bg-gray-100 border-transparent placeholder:!text-transparent focus:border-primary focus:ring-primary disabled:opacity-50 disabled:pointer-events-none dark:bg-bodybg2 rounded-lg dark:border-transparent
                                    focus:pt-6
                                    focus:pb-2
                                    [&:not(:placeholder-shown)]:pt-6
                                    [&:not(:placeholder-shown)]:pb-2
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Underline Floating label"
            code={input12}
            customCardBodyClass="space-y-3 underlined-floatiing-label"
          >
            <div className="relative">
              <input
                type="email"
                id="hs-floating-underline-input-email"
                className="peer py-4 px-0 ti-form-input rounded-none bg-transparent 
              ...
              <label
                ...
                className="absolute top-0 start-0 py-4 px-0 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                    peer-focus:text-xs
                                    peer-focus:-translate-y-1.5
                                    peer-focus:text-gray-500  dark:peer-focus:text-white/70
                                    peer-[:not(:placeholder-shown)]:text-xs
            ...
            <div className="relative">
              ...
              <label
                ...
                className="absolute top-0 start-0 py-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
                                    peer-focus:text-xs
                                    peer-focus:-translate-y-1.5
                                    peer-focus:text-gray-500  dark:peer-focus:text-white/70
                                    peer-[:not(:placeholder-shown)]:text-xs
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          ...
          >
            <input
              type="text"
              className="ti-form-input px-5 rounded-full"
              placeholder="Input text"
            />
            <textarea
              className="ti-form-input px-5 rounded-md"
              rows={3}
              placeholder="This is a textarea placeholder"
            ></textarea>
          </Showcode>
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          ...
          >
            ...
            <div>
              <label htmlFor="textarea-label" className="ti-form-label">
                Comment
              </label>
              <textarea
                id="textarea-label"
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          ...
          >
            <div>
              ...
              />
              <p
                className="text-xs text-gray-500 mt-2 dark:text-white/70"
        ...
        <div className="col-span-12 xxl:col-span-4">
          <Showcode
            title="Input With Inline helper text"
            code={input17}
            customCardBodyClass="space-y-3"
          >
            ...
            <div className="sm:inline-flex sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 w-full rtl:space-x-reverse">
              <label
                htmlFor="inline-textarea-label-with-helper-text"
                className="ti-form-label"
              >
                Leave your question
              </label>
              <textarea
                id="inline-textarea-label-with-helper-text"
                className="ti-form-input"
                rows={3}
                placeholder="Say hi, we'll be happy to chat with you."
                aria-describedby="hs-textarea-helper-text"
              ...
              <p
                className="text-xs text-gray-500 mt-2 dark:text-white/70"
                id="hs-inline-textarea-helper-text"
              >
                We'll get back to you soon.
              </p>
            </div>
        ...
        <div className="col-span-12 xxl:col-span-4">
          <Showcode
            ...
            code={input18}
            customCardBodyClass="space-y-4"
          >
            <div>
              <div className="flex justify-between items-center">
                <label htmlFor="with-corner-hint" className="ti-form-label">
                  Email
                </label>
                <span className="block text-xs text-gray-500 mb-2 dark:text-white/70">
                  Optional
                </span>
              </div>
              <input
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="ti-form-input !border-danger focus:border-danger focus:ring-danger"
                    required
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="ti-form-input !border-success focus:border-success focus:ring-success"
                    required
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode title="Input Sizes" code={input20} customCardBodyClass="">
            <div className="space-y-3">
              <input
                type="text"
                className="py-2 px-3 ti-form-input"
              ...
              <input
                type="text"
                className="ti-form-input sm:p-5"
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          ...
          >
            <div className="space-y-3">
              ...
              ></textarea>
              <textarea
                className="sm:p-5 py-3 px-4 ti-form-input"
                rows={2}
                placeholder="Large size"
              ></textarea>
            </div>
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          ...
          >
            <div className="relative">
              <textarea
                id="hs-textarea-ex-1"
                className="p-4 pb-12 ti-form-input focus:!ring-primary"
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode title="Autoheight" code={input23} customCardBodyClass="">
            <label htmlFor="hs-autoheight-textarea" className="ti-form-label">
              Contact us
            </label>
            <textarea
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="grid grid-cols-12">
            ...
            <div className="xl:col-span-12 col-span-12">
              <Showcode
                title=" Inline text can use any typical inline HTML element with nothing more
                                            than
