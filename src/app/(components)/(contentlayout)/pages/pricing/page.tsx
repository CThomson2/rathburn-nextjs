                      ...
                      <div className="!p-6">
                        ...
                        <ul className="list-none mb-0">
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1 inline-flex">
                                2 Free
                              </strong>
                              Websites
                            </span>
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1 inline-flex">1 GB</strong>
                              Hard disk storage
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1 inline-flex">2</strong>
                              Licenses
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                      ...
                      <div className="!p-6">
                        ...
                        <ul className="list-none mb-0">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1 inline-flex">5 GB</strong>
                              Hard disk storage
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1 inline-flex">5</strong>
                              Licenses
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                      ...
                      <div className="!p-6">
                        ...
                        <ul className="list-none mb-0">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1 inline-flex">15</strong>
                              Licenses
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
                      ...
                      <div className="!p-6">
                        ...
                        <ul className="list-none mb-0">
                          ...
                          <li className="flex items-center mb-4">
                            ...
                            <span>
                              <strong className="me-1 inline-flex">50</strong>
                              Licenses
                            </span>
                          </li>
                          <li className="flex items-center mb-4">
