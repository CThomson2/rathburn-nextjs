              ...
              <div className="flex items-start">
                ...
                <div className="flex-grow">
                  ...
                  <div className="flex flex-wrap items-center justify-between">
                    ...
                    <div id="btcCoin">
                      <ReactApexChart
                        options={Widgetsdata.Bitcoin.options}
                        series={Widgetsdata.Bitcoin.series}
                        type="line"
                        height={20}
                        width={100}
                      />
              ...
              <div className="flex items-start">
                ...
                <div className="flex-grow">
                  ...
                  <div className="flex flex-wrap items-center justify-between">
                    ...
                    <div id="ethCoin">
                      <ReactApexChart
                        options={Widgetsdata.Ethereum.options}
                        series={Widgetsdata.Ethereum.series}
                        type="line"
                        height={20}
                        width={100}
                      />
              ...
              <div className="flex items-start">
                ...
                <div className="flex-grow">
                  ...
                  <div className="flex flex-wrap items-center justify-between">
                    ...
                    <div id="dshCoin">
                      <ReactApexChart
                        options={Widgetsdata.Dash.options}
                        series={Widgetsdata.Dash.series}
                        type="line"
                        height={20}
                        width={100}
                      />
              ...
              <div className="flex items-start">
                ...
                <div className="flex-grow">
                  ...
                  <div className="flex flex-wrap items-center justify-between">
                    ...
                    <div id="glmCoin">
                      <ReactApexChart
                        options={Widgetsdata.Golem.options}
                        series={Widgetsdata.Golem.series}
                        type="line"
                        height={20}
                        width={100}
                      />
            ...
            <div className="xl:col-span-6 col-span-12">
              <div className="box custom-box overflow-hidden">
                <div className="box-body !p-0">
                  ...
                  <div id="totalRevenue">
                    <ReactApexChart
                      options={Widgetsdata.TotalRevenue.options}
                      series={Widgetsdata.TotalRevenue.series}
                      type="area"
                      width={"100%"}
                      height={180}
                    />
        ...
        <div className="xl:col-span-4 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="views">
                <ReactApexChart
                  options={Widgetsdata.Applicants.options}
                  series={Widgetsdata.Applicants.series}
                  type="line"
                  width={"100%"}
                  height={350}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="sessionsByDevice">
                <ReactApexChart
                  options={Widgetsdata.Sessions.options}
                  series={Widgetsdata.Sessions.series}
                  type="bubble"
                  width={"100%"}
                  height={350}
                />
        ...
        <div className="xl:col-span-4 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body pb-4">
              ...
              <div id="report">
                <ReactApexChart
                  options={Widgetsdata.Targetreport.options}
                  series={Widgetsdata.Targetreport.series}
                  type="bar"
                  width={"100%"}
                  height={235}
                />
