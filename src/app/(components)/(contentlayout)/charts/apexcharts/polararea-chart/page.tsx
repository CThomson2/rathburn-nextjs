  ...
  return (
    <Fragment>
      ...
      <Pageheader
        ...
        mainpage="Apex Polar Area Charts"
      />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="polararea-basic">
                <ReactApexChart
                  options={Polardata.Basicpolararea.options}
                  series={Polardata.Basicpolararea.series}
                  type="polarArea"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="polararea-monochrome">
                <ReactApexChart
                  options={Polardata.Monochromepolar.options}
                  series={Polardata.Monochromepolar.series}
                  type="polarArea"
                  width={"100%"}
                  height={320}
                />
