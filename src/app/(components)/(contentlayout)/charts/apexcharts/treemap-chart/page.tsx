          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="treemap-basic">
                <ReactApexChart
                  options={Treedata.Basictreemap.options}
                  series={Treedata.Basictreemap.series}
                  type="treemap"
                  width={"100%"}
                  height={350}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="treemap-multi">
                <ReactApexChart
                  options={Treedata.Multidimensional.options}
                  series={Treedata.Multidimensional.series}
                  type="treemap"
                  width={"100%"}
                  height={350}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="treemap-distributed">
                <ReactApexChart
                  options={Treedata.Distributedtree.options}
                  series={Treedata.Distributedtree.series}
                  type="treemap"
                  width={"100%"}
                  height={350}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="treemap-colorranges">
                <ReactApexChart
                  options={Treedata.Colorrangetree.options}
                  series={Treedata.Colorrangetree.series}
                  type="treemap"
                  width={"100%"}
                  height={350}
                />
