        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="pie-basic">
                <ReactApexChart
                  options={Piedata.Basicpiechart.options}
                  series={Piedata.Basicpiechart.series}
                  type="pie"
                  width={"100%"}
                  height={300}
                />
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="donut-simple">
                <ReactApexChart
                  options={Piedata.Simpledonut.options}
                  series={Piedata.Simpledonut.series}
                  type="donut"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body !px-0">
              <div id="pie-monochrome">
                <ReactApexChart
                  options={Piedata.Monochrome.options}
                  series={Piedata.Monochrome.series}
                  type="pie"
                  width={"100%"}
                  height={280}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="donut-gradient">
                <ReactApexChart
                  options={Piedata.Gradientpie.options}
                  series={Piedata.Gradientpie.series}
                  type="donut"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="donut-pattern">
                <ReactApexChart
                  options={Piedata.Donutwithpattern.options}
                  series={Piedata.Donutwithpattern.series}
                  type="donut"
                  width={"100%"}
                  height={250}
                />
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="pie-image">
                <ReactApexChart
                  options={Piedata.Imagefilledpie.options}
                  series={Piedata.Imagefilledpie.series}
                  type="pie"
                  width={"100%"}
                  height={300}
                />
