        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="radar-basic">
                <ReactApexChart
                  options={Radardata.Basicradar.options}
                  series={Radardata.Basicradar.series}
                  type="radar"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="radar-multiple">
                <ReactApexChart
                  options={Radardata.Multipleradar.options}
                  series={Radardata.Multipleradar.series}
                  type="radar"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="radar-polygon">
                <ReactApexChart
                  options={Radardata.Polygonradar.options}
                  series={Radardata.Polygonradar.series}
                  type="radar"
                  width={"100%"}
                  height={320}
                />
