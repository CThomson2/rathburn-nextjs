          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="boxplot-basic">
                <ReactApexChart
                  options={Boxplotdata.Basicboxplot.options}
                  series={Boxplotdata.Basicboxplot.series}
                  type="boxPlot"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="boxplot-scatter">
                <ReactApexChart
                  options={Boxplotdata.Boxplotscatter.options}
                  series={Boxplotdata.Boxplotscatter.series}
                  type="boxPlot"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="boxplot-horizontal">
                <ReactApexChart
                  options={Boxplotdata.Boxplothorizontal.options}
                  series={Boxplotdata.Boxplothorizontal.series}
                  type="boxPlot"
                  width={"100%"}
                  height={320}
                />
