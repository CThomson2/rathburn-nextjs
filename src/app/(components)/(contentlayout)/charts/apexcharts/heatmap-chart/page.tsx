          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="heatmap-basic">
                <ReactApexChart
                  options={Heatdata.Basiheatmap.options}
                  series={Heatdata.Basiheatmap.series}
                  type="heatmap"
                  width={"100%"}
                  height={350}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="heatmap-multiseries">
                <ReactApexChart
                  options={Heatdata.Multiseriesheatmap.options}
                  series={Heatdata.Multiseriesheatmap.series}
                  type="heatmap"
                  width={"100%"}
                  height={350}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="heatmap-colorrange">
                <ReactApexChart
                  options={Heatdata.Colorrange.options}
                  series={Heatdata.Colorrange.series}
                  type="heatmap"
                  width={"100%"}
                  height={350}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="heatmap-range">
                <ReactApexChart
                  options={Heatdata.Shadesheatmap.options}
                  series={Heatdata.Shadesheatmap.series}
                  type="heatmap"
                  width={"100%"}
                  height={350}
                />
