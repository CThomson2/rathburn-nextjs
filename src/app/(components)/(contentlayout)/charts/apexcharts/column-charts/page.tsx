        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="column-basic">
                <ReactApexChart
                  options={Columndata.Basicolumn.options}
                  series={Columndata.Basicolumn.series}
                  type="bar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="column-datalabels">
                <ReactApexChart
                  options={Columndata.Columnwithlabels.options}
                  series={Columndata.Columnwithlabels.series}
                  type="bar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="column-stacked">
                <ReactApexChart
                  options={Columndata.Stackedcolumn.options}
                  series={Columndata.Stackedcolumn.series}
                  type="bar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="column-stacked-full">
                <ReactApexChart
                  options={Columndata.Stacked100column.options}
                  series={Columndata.Stacked100column.series}
                  type="bar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="column-markers">
                <ReactApexChart
                  options={Columndata.Markers.options}
                  series={Columndata.Markers.series}
                  type="bar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="column-rotated-labels">
                <ReactApexChart
                  options={Columndata.Rotated.options}
                  series={Columndata.Rotated.series}
                  type="bar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="column-negative">
                <ReactApexChart
                  options={Columndata.Negativecolumn.options}
                  series={Columndata.Negativecolumn.series}
                  type="bar"
                  width={"100%"}
                  height={300}
                />
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="column-range">
                <ReactApexChart
                  options={Columndata.Rangecolumn.options}
                  series={Columndata.Rangecolumn.series}
                  type="bar"
                  width={"100%"}
                  height={300}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="columns-distributed">
                <ReactApexChart
                  options={Columndata.Distributed.options}
                  series={Columndata.Distributed.series}
                  type="bar"
                  width={"100%"}
                  height={350}
                />
