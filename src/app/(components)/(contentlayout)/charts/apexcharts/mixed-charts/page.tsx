          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="mixed-linecolumn">
                <ReactApexChart
                  options={Mixedata.Mixedlinecolumn.options}
                  series={Mixedata.Mixedlinecolumn.series}
                  type="line"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="mixed-multiple-y">
                <ReactApexChart
                  options={Mixedata.MultipleYaxis.options}
                  series={Mixedata.MultipleYaxis.series}
                  type="line"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="mixed-linearea">
                <ReactApexChart
                  options={Mixedata.Linearea.options}
                  series={Mixedata.Linearea.series}
                  type="line"
                  width={"100%"}
                  height={320}
                />
        ...
        <div className="xl:col-span-6 col-span-12">
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="mixed-all">
                <ReactApexChart
                  options={Mixedata.Linecolumnarea.options}
                  series={Mixedata.Linecolumnarea.series}
                  type="line"
                  width={"100%"}
                  height={320}
                />
