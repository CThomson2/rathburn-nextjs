          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="timeline-basic">
                <ReactApexChart
                  options={Timelinedata.Basictimeline.options}
                  series={Timelinedata.Basictimeline.series}
                  type="rangeBar"
                  width={"100%"}
                  height={350}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="timeline-colors">
                <ReactApexChart
                  options={Timelinedata.Multiplecolored.options}
                  series={Timelinedata.Multiplecolored.series}
                  type="rangeBar"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="timeline-multi">
                <ReactApexChart
                  options={Timelinedata.Timelinemulti.options}
                  series={Timelinedata.Timelinemulti.series}
                  type="rangeBar"
                  height={320}
                  width={"100%"}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="timeline-advanced">
                <ReactApexChart
                  options={Timelinedata.Advancedmultirange1.options}
                  series={Timelinedata.Advancedmultirange1.series}
                  type="rangeBar"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="timeline-grouped">
                <ReactApexChart
                  options={Timelinedata.Timelinegrouped1.options}
                  series={Timelinedata.Timelinegrouped1.series}
                  type="rangeBar"
                  width={"100%"}
                  height={320}
                />
