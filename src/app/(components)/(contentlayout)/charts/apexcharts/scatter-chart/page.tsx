          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="scatter-basic">
                <ReactApexChart
                  options={Scatterdata.Basicscatter.options}
                  series={Scatterdata.Basicscatter.series}
                  type="scatter"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="scatter-datetime">
                <ReactApexChart
                  options={Scatterdata.Datetimescatter.options}
                  series={Scatterdata.Datetimescatter.series}
                  type="scatter"
                  width={"100%"}
                  height={320}
                />
          ...
          <div className="box custom-box">
            ...
            <div className="box-body">
              <div id="scatter-image">
                <ReactApexChart
                  options={Scatterdata.Imagefillescatter.options}
                  series={Scatterdata.Imagefillescatter.series}
                  type="scatter"
                  width={"100%"}
                  height={320}
                />
