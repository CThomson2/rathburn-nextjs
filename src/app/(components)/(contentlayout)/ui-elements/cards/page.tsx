    ...
    <>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <Link
                href="#!"
                scroll={false}
                className="card-link text-primary me-2"
              >
                Card link
              </Link>
              <Link
        ...
        <div className="xl:col-span-3 col-span-12">
          ...
          <div className="box border border-success mb-4">
            ...
            <div className="box-body text-success">
              <p className="box-title !font-semibold !text-success">
                Looking For Success?
              </p>
              <p className="card-text">
          ...
          <div className="box text-center">
            ...
            <div className="box-body">
              ...
              <Link
                href="#!"
                scroll={false}
                className="ti-btn ti-btn-primary-full mt-2 me-2"
              >
                Read More
              </Link>
              <Link
              ...
              <div className="box text-center">
                <div className="box-header !justify-start">
                  <ul className="nav nav-tabs box-header-tabs ms-1 flex   gap-2 items-center">
                    ...
                    <li className="nav-item">
                      <Link className="nav-link" href="#!" scroll={false}>
                        Link
                      </Link>
                    </li>
                    <li className="nav-item">
          ...
          <div className="box overlay-card">
            ...
            <div className="card-img-overlay flex flex-column p-0 over-content-bottom">
              <div className="box-body sm:!p-4 !p-2 text-white">
                ...
                <div className="card-text overflow-y-scroll mb-2 !text-white">
                  There are many variations of passages of Lorem Ipsum
                  available, but the majority have suffered alteration in some
                  form, by injected humour, or randomised words which don't look
                  even.
          ...
          <div className="box border border-primary !rounded-md">
            <div className="box-body">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <span className="badge bg-tealmain/10 text-teal">
                  Codeignitor
                </span>
      ...
      <div className="grid grid-cols-12 gap-x-6 mb-4 gap-y-3">
        <div className="xl:col-span-6 lg:col-span-12 col-span-12">
          ...
          <div className="grid border rounded-xl shadow-sm divide-y overflow-hidden sm:flex sm:divide-y-0 sm:divide-x dark:border-white/10 dark:divide-white/10">
        ...
        <div className="xl:col-span-3 lg:col-span-6 col-span-12">
          ...
          <a
            className="flex flex-col group bg-white border shadow-sm rounded-xl overflow-hidden hover:shadow-lg transition dark:bg-bodybg dark:border-white/10"
            href="#!"
          >
        ...
        <div className="xl:col-span-3 lg:col-span-6 col-span-12">
          ...
          <a
            className="flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-lg transition dark:bg-bodybg dark:border-white/10"
            href="#!"
          >
            <img
      ...
      <div className="grid grid-cols-12 gap-x-6 mb-4 gap-y-3">
        <div className="xl:col-span-4 col-span-12">
          ...
          <div className="flex flex-col bg-white border border-t-4 border-primary/60 shadow-sm rounded-xl dark:bg-bodybg dark:border-white/10 dark:border-t-primary/60 dark:shadow-slate-700/[.7]">
            <div className="box-body">
              <h3 className="text-lg font-bold text-gray-800 dark:text-white">
                Card title
              </h3>
              ...
              >
                Card link
                <svg
                  className="flex-shrink-0 size-4 rtl:origin-center rotate-180"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
        ...
        <div className="xl:col-span-4 col-span-12">
          ...
          <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-bodybg dark:border-white/10 dark:shadow-slate-700/[.7]">
            <div className="border-b rounded-t-xl py-3 px-4 md:py-4 md:px-5 dark:border-white/10">
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-500">
                Featured
              </p>
            </div>
            <div className="bg-bodybg border border-defaultborder text-sm  p-4 dark:bg-bodybg dark:border-white/10 dark:text-white">
              <span className="font-bold">Attention needed!</span> This is an
              alert box.
            </div>
            <div className="box-body">
              <h3 className="text-lg font-bold text-gray-800 dark:text-white">
