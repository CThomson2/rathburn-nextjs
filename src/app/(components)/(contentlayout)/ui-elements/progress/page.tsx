  ...
  return (
    <>
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Basic Progress" code={progress1}>
            {basicprogress.map((idx) => (
              <div
                className={`progress !rounded-full ${idx.class}`}
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Multiple Bars With Sizes" code={progress6}>
            ...
            <div className="progress-stacked progress-lg mb-4 flex">
              <div
                className="progress-bar !bg-purplemain w-1/5"
                role="progressbar"
                aria-valuenow={20}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-tealmain !rounded-none w-1/4"
                role="progressbar"
                aria-valuenow={25}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="progress-bar !bg-orangemain !rounded-none w-[30%]"
                role="progressbar"
                aria-valuenow={30}
                aria-valuemin={0}
                aria-valuemax={100}
      ...
      <div className="grid grid-cols-12 gap-6">
          ...
          <Showcode title="Labels at The end" code={progress7}>
            <div className="flex items-center gap-x-3 whitespace-nowrap w-full mb-4">
              <div className="ti-main-progress w-full progress bg-gray-200 dark:bg-bodybg">
                <div
                  className="ti-main-progress-bar bg-primary text-xs text-white text-center"
                  style={{ width: "25%" }}
                  role="progressbar"
                  aria-valuenow={25}
                  aria-valuemin={0}
            ...
            <div className="flex items-center gap-x-3 whitespace-nowrap w-full mb-4">
              <div className="ti-main-progress w-full progress bg-gray-200 dark:bg-bodybg">
                <div
                  className="ti-main-progress-bar bg-danger text-xs text-white text-center"
                  style={{ width: "100%" }}
                  role="progressbar"
                  aria-valuenow={100}
                  aria-valuemin={0}
            ...
            <div className="flex items-center gap-x-3 whitespace-nowrap w-full mb-4">
              <div className="ti-main-progress w-full progress bg-gray-200 dark:bg-bodybg">
                <div
                  className="ti-main-progress-bar bg-success text-xs text-white text-center"
                  style={{ width: "100%" }}
                  role="progressbar"
                  aria-valuenow={100}
                  aria-valuemin={0}
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode
            title="Progress With Title Label"
            code={progress8}
        ...
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            <div className="max-w-40 ti-main-progress !h-full items-center gap-x-1">
              <div
                className="w-full h-2.5 ti-main-progress-bar bg-primary text-xs text-white text-center whitespace-nowrap transition duration-500"
                role="progressbar"
                aria-valuenow={25}
                aria-valuemin={0}
                aria-valuemax={100}
              ...
              ></div>
              <div
                className="w-full h-2.5 ti-main-progress-bar bg-gray-200 dark:bg-bodybg text-xs text-white text-center whitespace-nowrap transition duration-500"
                role="progressbar"
                aria-valuenow={25}
                aria-valuemin={0}
                aria-valuemax={100}
            ...
            <div className="max-w-40 ti-main-progress !h-full items-center gap-x-1">
              <div
                className="w-full h-2.5 ti-main-progress-bar bg-danger text-xs text-white text-center whitespace-nowrap transition duration-500"
                role="progressbar"
                aria-valuenow={25}
                aria-valuemin={0}
                aria-valuemax={100}
              ></div>
              <div
                className="w-full h-2.5 ti-main-progress-bar bg-danger/10 text-xs text-white text-center whitespace-nowrap transition duration-500"
                role="progressbar"
                aria-valuenow={25}
                aria-valuemin={0}
                aria-valuemax={100}
            ...
            <div className="max-w-40 ti-main-progress !h-full items-center gap-x-1">
              <div
                className="w-full h-2.5 ti-main-progress-bar bg-success text-xs text-white text-center whitespace-nowrap transition duration-500"
                role="progressbar"
                aria-valuenow={25}
                aria-valuemin={0}
                aria-valuemax={100}
          ...
          >
            <div className="flex space-x-8 rtl:space-x-reverse">
              <div className="ti-main-progress flex-col flex-nowrap justify-end !w-2 !h-[17rem] bg-gray-200 dark:bg-bodybg">
                <div
                  className="bg-primary ti-main-progress-bar"
                  style={{ height: "25%" }}
                  role="progressbar"
                  aria-valuenow={25}
                  aria-valuemin={0}
              ...
              <div className="ti-main-progress flex-col flex-nowrap justify-end !w-2 !h-[17rem] bg-gray-200 dark:bg-bodybg">
                <div
                  className="bg-secondary ti-main-progress-bar"
                  style={{ height: "40%" }}
                  role="progressbar"
                  aria-valuenow={40}
                  aria-valuemin={0}
              ...
              <div className="ti-main-progress flex-col flex-nowrap justify-end !w-2 !h-[17rem] bg-gray-200 dark:bg-bodybg">
                <div
                  className="bg-warning ti-main-progress-bar"
                  style={{ height: "60%" }}
                  role="progressbar"
                  aria-valuenow={60}
                  aria-valuemin={0}
              ...
              <div className="ti-main-progress flex-col flex-nowrap justify-end !w-2 !h-[17rem] bg-gray-200 dark:bg-bodybg">
                <div
                  className="bg-info ti-main-progress-bar"
                  style={{ height: "80%" }}
                  role="progressbar"
                  aria-valuenow={80}
                  aria-valuemin={0}
              ...
              <div className="ti-main-progress flex-col flex-nowrap justify-end !w-2 !h-[17rem] bg-gray-200 dark:bg-bodybg">
                <div
                  className="bg-danger ti-main-progress-bar"
                  style={{ height: "100%" }}
                  role="progressbar"
                  aria-valuenow={100}
                  aria-valuemin={0}
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Custom Animated Progress" code={progress14}>
            {Gradient.map((idx) => (
              <div
                className={`progress ${idx.class} progress-animate`}
                role="progressbar"
                aria-valuenow={Number(idx.valuenow)}
                aria-valuemin={0}
                aria-valuemax={100}
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Custom Progress-4" code={progress18}>
            {Custom.map((idx) => (
              <div
                className={`progress progress-xl ${idx.class} progress-animate custom-progress-4 ${idx.color}`}
                role="progressbar"
                aria-valuenow={Number(idx.valuenow)}
                aria-valuemin={0}
                aria-valuemax={100}
