    ...
    <div>
          ...
          >
            <div className="ti-btn-list">
              <div className="hs-tooltip ti-main-tooltip [--trigger:click]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-primary"
                  href="#!"
                  scroll={false}
                >
                  Popover Top
        ...
        <div className="xl:col-span-7 col-span-12">
          ...
          >
            <div className="ti-btn-list">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-secondary"
                  href="#!"
                  scroll={false}
                >
                  Header Secondary
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:bottom]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-info"
                  href="#!"
                  scroll={false}
                >
                  Header Info
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:left]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-warning"
                  href="#!"
                  scroll={false}
                >
                  Header warning
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-success"
                  href="#!"
                  scroll={false}
                >
                  Header succuss
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-outline-danger"
                  href="#!"
                  scroll={false}
                >
                  Header danger
        ...
        <div className="xl:col-span-12 col-span-12">
          ...
          >
            <div className="ti-btn-list">
              <div className="hs-tooltip ti-main-tooltip  [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-primary-full"
                  href="#!"
                  scroll={false}
                >
                  Primary
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-primary !z-[1000] !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-secondary-full"
                  href="#!"
                  scroll={false}
                >
                  Secondary
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-secondary !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
                    <div className="!border-b !border-solid dark:border-white/10 !py-2 !px-4 text-white border-white/10 !rounded-t-md text-start w-full text-[1rem]">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-info-full"
                  href="#!"
                  scroll={false}
                >
                  Info
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-warning-full"
                  href="#!"
                  scroll={false}
                >
                  Warning
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-warning  !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
                    <div className="!border-b dark:border-white/10 !border-solid !py-2 !px-4 text-white border-white/10 !rounded-t-md text-start w-full text-[1rem]">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-success-full"
                  href="#!"
                  scroll={false}
                >
                  Success
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-success  !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
                    <div className="!border-b dark:border-white/10 !border-solid !py-2 !px-4 text-white border-white/10 !rounded-t-md text-start w-full text-[1rem]">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-danger-full"
                  href="#!"
                  scroll={false}
                >
                  Danger
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !bg-danger  !p-0 !max-w-[276px] !border-white/10"
                    role="tooltip"
                  >
                    <div className="!border-b dark:border-white/10 !border-solid !py-2 !px-4 text-white border-white/10 !rounded-t-md text-start w-full text-[1rem]">
        ...
        <div className="xl:col-span-12 col-span-12">
          ...
          >
            <div className="ti-btn-list">
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top] ">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-primary"
                  href="#!"
                  scroll={false}
                >
                  Primary
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-secondary"
                  href="#!"
                  scroll={false}
                >
                  Secondary
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-info"
                  href="#!"
                  scroll={false}
                >
                  Info
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-warning"
                  href="#!"
                  scroll={false}
                >
                  Warning
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-success"
                  href="#!"
                  scroll={false}
                >
                  Success
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:right]">
                <Link
                  className="hs-tooltip-toggle ti-main-tooltip-toggle ti-btn ti-btn-danger"
                  href="#!"
                  scroll={false}
                >
                  danger
          ...
          >
            <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:top]">
              ...
              >
                Disabled button
                <div
                  className="hs-tooltip-content ti-main-tooltip-content dark:bg-bodybg "
                  role="tooltip"
                >
                  Disabled Popover
                </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Popover With Four Directions"
            customCardClass=""
            customCardBodyClass=""
            code={popover7}
          >
            <div className="flex justify-center gap-4">
              ...
              <div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:left]">
                ...
                >
                  ...
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content hidden"
                    role="tooltip"
        ...
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Popover With Focus event"
            customCardClass=""
            customCardBodyClass=""
            code={popover8}
          >
            ...
            <div className="flex justify-center">
              <div className="hs-tooltip ti-main-tooltip [--trigger:click]">
                ...
                >
                  ...
                  <div
                    className="hs-tooltip-content ti-main-tooltip-content !p-0 max-w-xs border-gray-200 text-start rounded-sm hidden"
                    role="tooltip"
          ...
          >
            <div className="hs-tooltip ti-main-tooltip [--trigger:click]">
              <div className="hs-tooltip-toggle ti-main-tooltip-toggle">
                ...
                <div
                  className="hs-tooltip-content ti-main-tooltip-content max-w-xs w-full hidden"
                  role="tooltip"
                  ...
                  <div className="p-4">
                    ...
                    <div className="mb-3">
                      <div className="flex items-center gap-x-3 whitespace-nowrap mb-2">
                        ...
                        <div
                          className="flex w-full h-2 bg-gray-200 rounded-full overflow-hidden dark:bg-light"
                          role="progressbar"
                          aria-valuenow={78}
                          aria-valuemin={0}
                          aria-valuemax={100}
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-6 xxl:col-span-3">
          <Showcode
            title="Popover With Hover event"
            customCardClass=""
            customCardBodyClass=""
            code={popover11}
          >
          ...
          >
            <div className="hs-tooltip inline-block [--trigger:hover] sm:[--placement:right]">
              <div className="hs-tooltip-toggle max-w-xs p-3 flex items-center gap-x-3 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-bodybg dark:border-white/10">
                ...
                <div
                  className="hs-tooltip-content overflow-hidden ti-main-tooltip-content !p-0 max-w-xs w-full after:absolute after:top-0 after:-start-4 after:w-4 after:h-full hidden"
                  role="tooltip"
                ...
                >
                  <div className="py-3 px-4 border-b border-gray-200 dark:border-white/10">
                    <div className="flex items-center gap-x-3">
                      <img
                        className="flex-shrink-0 inline-block size-10 rounded-full ring-2 ring-white dark:ring-bodybg"
                        src="../../assets/images/faces/1.jpg"
                        alt="Image Description"
                      />
                      <div className="grow">
                  ...
                  <div className="py-2 px-4 flex justify-between items-center bg-gray-100 dark:bg-bodybg">
                    ...
                    <button
                      type="button"
                      className="py-1.5 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent bg-primary text-white hover:bg-primary/80 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-primary"
                    >
                      Follow
                    </button>
                  </div>
