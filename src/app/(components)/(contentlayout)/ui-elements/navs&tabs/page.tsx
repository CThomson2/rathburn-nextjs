      ...
      <div className="grid grid-cols-12 gap-x-6">
              ...
              <div className="flex">
                <div className="border-e border-gray-200 dark:border-white/10">
                  ...
                  >
                    <button
                      type="button"
                      className="hs-tab-active:bg-white hs-tab-active:border-e-transparent  hs-tab-active:text-primary dark:hs-tab-active:bg-transparent !dark:hs-tab-active:border-e-gray-800 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-defaulttextcolor  rounded-s-sm hover:text-primary dark:bg-black/20 dark:border-white/10 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-gray-300 active"
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="border-b-2 border-gray-200 dark:border-white/10">
                <nav
                  className="-mb-0.5 flex space-x-6 rtl:space-x-reverse"
                  role="tablist"
                >
                  <Link
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="sm:border-b-2 border-gray-200 dark:border-white/10">
                <nav
                  className="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse"
                  role="tablist"
                >
                  <Link
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <nav
                className="relative z-0 sm:flex border rounded-sm divide-y sm:divide-y-0 sm:divide-x rtl:divide-x-reverse divide-gray-200 overflow-hidden dark:border-white/10 dark:divide-white/10 "
                role="tablist"
              >
                <Link
