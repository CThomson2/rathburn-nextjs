...
const Blackquotes = () => {
  return (
    <>
      ...
      <Pageheader
        currentpage="Blockquotes"
        activepage="Ui Elements"
        mainpage="Blockquotes"
      />
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12">
          ...
          >
            <blockquote className="relative">
              <svg
                className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100 dark:text-white/10"
                width="16"
                height="16"
                viewBox="0 0 16 16"
                fill="none"
        ...
        <div className="col-span-12">
          <Showcode
            title="Center Aligned Blockquote"
            code={blackquote5}
            customCardBodyClass=""
          >
              ...
              <div className="relative z-10">
                <p className="text-xl text-gray-800">
                  <em className="relative">
                    <svg
                      className="absolute top-0 ltr:left-0 rtl:right-0 transform -translate-x-8 -translate-y-8 h-16 w-16 text-gray-100 sm:h-24 sm:w-24 dark:text-white/10"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                      fill="none"
        ...
        <div className="col-span-12">
          <Showcode
            title="Left Bordered Blockquote"
            code={blackquote9}
            customCardBodyClass=""
          >
