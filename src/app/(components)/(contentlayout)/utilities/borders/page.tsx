      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-6 col-span-12">
          <Showcode title="Border With Opacity" code={border6}>
            ...
            <div className="border border-success/75  p-2 mb-2">
              This is 75% opacity success border
            </div>
            <div className="border border-success/50  p-2 mb-2">
              This is 50% opacity success border
            </div>
            <div className="border border-success/25  p-2 mb-2 ">
              This is 25% opacity success border
            </div>
            <div className="border border-success/10 p-2">
