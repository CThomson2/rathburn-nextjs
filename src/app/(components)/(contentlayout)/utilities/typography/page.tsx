    ...
    <>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 lg:col-span-6">
          ...
          >
            <h1 className="font-semibold text-gray-800 dark:text-white text-4xl">
              h1. Tailwind heading
            </h1>
            <h2 className="font-semibold text-gray-800 dark:text-white text-3xl">
              h2. Tailwind heading
            </h2>
            <h3 className="font-semibold text-gray-800 dark:text-white text-2xl">
              h3. Tailwind heading
            </h3>
            ...
            <h6 className="font-semibold text-gray-800 dark:text-white text-base">
              h6. Tailwind heading
            </h6>
          </Showcode>
        </div>
        ...
        <div className="col-span-12 lg:col-span-6">
          ...
          >
            <dl className="grid sm:grid-cols-3 gap-1 sm:gap-3">
              <dt className="sm:col-span-1 font-semibold dark:text-white">
                Description lists
              </dt>
              ...
              <dt className="sm:col-span-1 font-semibold truncate dark:text-white">
              ...
              <dd className="sm:col-span-2 mb-3 sm:mb-0 dark:text-white">
                <dl className="grid sm:grid-cols-5 gap-1 sm:gap-3 dark:text-white">
                  <dt className="sm:col-span-2 font-semibold dark:text-white">
                    Nested definition list
                  </dt>
                  <dd className="sm:col-span-3 mb-3 sm:mb-0 dark:text-white">
        ...
        <div className="col-span-12 lg:col-span-6">
          ...
          >
            ...
            <p className="text-gray-800 dark:text-white text-[6.5rem] leading-none sm:text-9xl">
              text-9xl
            </p>
          </Showcode>
        </div>
        <div className="col-span-12 lg:col-span-6">
          <Showcode
            title="Open/closed state"
            code={typography6}
            customCardBodyClass="space-y-8"
          >
            <div className="">
              <details
                className="open:bg-white dark:open:bg-bodybg open:ring-1 open:ring-black/5 dark:open:ring-white/10 open:shadow-lg p-6 rounded-lg"
                open
              >
          ...
          <Showcode
            ...
            customCardBodyClass="space-y-3"
          >
            <p className="text-gray-800 dark:text-white underline ">
              This line of text will render as underlined.{" "}
            </p>
            <p className="text-gray-800 dark:text-white no-underline ">
              This line of text will render as Not underlined..{" "}
            </p>
            <p className="text-gray-800 dark:text-white overline">
              This line of text will render as overline..
            </p>
            <p className="text-gray-800 dark:text-white line-through">
              This line of text will render as line through.
            </p>
          </Showcode>
          <Showcode
            ...
            customCardBodyClass="space-y-3"
          >
            <p className="text-gray-800 dark:text-white lowercase ">
              Lowercased text.{" "}
            </p>
            <p className="text-gray-800 dark:text-white uppercase ">
              Uppercased text
            </p>
            <p className="text-gray-800 dark:text-white capitalize">
              Captalized text
            </p>
            <p className="text-gray-800 dark:text-white normal-case">
              Normal Text
            </p>
          </Showcode>
        </div>
