        ...
        <div className="xl:col-span-6 col-span-12">
          ...
          >
            ...
            <div
              ...
              className="hs-overlay-backdrop-open:bg-primary/50 hs-overlay ti-offcanvas ti-offcanvas-left hidden"
            >
              <div className="ti-offcanvas-header">
                <h6 className="ti-offcanvas-title">Notifications</h6>
                <button
                  ...
                  <li className="ti-list-group bg-white text-gray-800 py-[0.75rem] px-[1rem] dark:bg-bodybg dark:border-white/10 dark:text-white !border-t-0 !border-x-0 !rounded-none">
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-auto">
                        <p className="font-semibold mb-0">
                          New Website Created
                          <span className="badge bg-gray-100 text-gray-500 dark:text-white/70 dark:bg-bodybg float-end px-2 py-1 leading-none text-[10px]">
                            20 Nov 2022
                          </span>
                        </p>
                        <span className="text-xs text-gray-500 dark:text-white/70 inline-flex">
                          <i className="ri-time-line align-middle me-1"></i>30
                          mins ago
                        </span>
                      </div>
                    </div>
                  ...
                  <li className="ti-list-group bg-white text-gray-800 dark:bg-bodybg dark:border-white/10 dark:text-white !border-x-0 py-[0.75rem] px-[1rem] !rounded-none !border-t-0">
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-auto">
                        ...
                        <span className="text-xs text-gray-500 dark:text-white/70 inline-flex">
                          <i className="ri-time-line align-middle me-1"></i>2
                          hrs ago
                        </span>
                      </div>
                    </div>
                  ...
                  <li className="ti-list-group bg-white text-gray-800 dark:bg-bodybg dark:border-white/10 dark:text-white !border-x-0 py-[0.75rem] px-[1rem] !rounded-none !border-t-0">
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-auto">
                        ...
                        <span className="text-xs text-gray-500 dark:text-white/70 inline-flex">
                          <i className="ri-time-line align-middle me-1"></i>3
                          hrs ago
                        </span>
                      </div>
                    </div>
                  ...
                  <li className="ti-list-group bg-white text-gray-800 dark:bg-bodybg dark:border-white/10 dark:text-white !border-x-0 py-[0.75rem] px-[1rem] !rounded-none !border-t-0">
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-auto">
                        ...
                        <span className="text-xs text-gray-500 dark:text-white/70 inline-flex">
                          <i className="ri-time-line align-middle me-1"></i>4
                          hrs ago
                        </span>
                      </div>
                    </div>
                  ...
                  <li className="ti-list-group bg-white text-gray-800 dark:bg-bodybg dark:border-white/10 dark:text-white !border-x-0 py-[0.75rem] px-[1rem] !rounded-none !border-t-0">
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-auto">
                        ...
                        <span className="text-xs text-gray-500 dark:text-white/70 inline-flex">
                          <i className="ri-time-line align-middle me-1"></i>7
                          hrs ago
                        </span>
                      </div>
                    </div>
                  ...
                  <li className="ti-list-group bg-white text-gray-800 dark:bg-bodybg dark:border-white/10 dark:text-white !border-x-0 py-[0.75rem] px-[1rem] !rounded-none !border-t-0">
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-auto">
                        ...
                        <span className="text-xs text-gray-500 dark:text-white/70 inline-flex">
                          <i className="ri-time-line align-middle me-1"></i>45
                          mins ago
                        </span>
                      </div>
                    </div>
                  ...
                  <li className="ti-list-group bg-white text-gray-800 dark:bg-bodybg dark:border-white/10 dark:text-white !border-x-0 py-[0.75rem] px-[1rem] !rounded-none !border-t-0">
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-auto">
                        ...
                        <span className="text-xs text-gray-500 dark:text-white/70 inline-flex">
                          <i className="ri-time-line align-middle me-1"></i>28
                          mins ago
                        </span>
                      </div>
                    </div>
                  ...
                  <li className="ti-list-group bg-white text-gray-800 dark:bg-bodybg dark:border-white/10 dark:text-white !border-x-0 py-[0.75rem] px-[1rem] !rounded-none !border-t-0">
                    <div className="flex items-center w-full">
                      ...
                      <div className="flex-auto">
                        ...
                        <span className="text-xs text-gray-500 dark:text-white/70 inline-flex">
                          <i className="ri-time-line align-middle me-1"></i>14
                          hrs ago
                        </span>
                      </div>
                    </div>
