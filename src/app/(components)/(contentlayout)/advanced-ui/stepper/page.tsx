            ...
            <div data-hs-stepper>
              <ul className="relative sm:flex flex-row gap-x-2 sm:space-y-0 space-y-4">
                ...
                >
                  ...
                  <div className="hidden sm:block hidden sm:block w-full h-px flex-1 bg-gray-200  dark:bg-light group-last:hidden hs-stepper-success:!bg-primary hs-stepper-completed:!bg-success"></div>
                </li>
                <li
                  className="flex items-center gap-x-2 shrink basis-0 flex-1 group"
              ...
              <div className="mt-5 sm:mt-8">
                <div data-hs-stepper-content-item='{"index": 1}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Name1" className="ti-form-label">
                          Name:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Email1" className="ti-form-label">
                          Email:{" "}
                        </label>
                        <input
                          type="email"
                ...
                <div data-hs-stepper-content-item='{"index": 2}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Telephone1" className="ti-form-label">
                          Telephone:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Mobile2" className="ti-form-label">
                          Mobile:{" "}
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                      <div className="col-span-12">
                        <label htmlFor="cardholder1" className="ti-form-label">
                          CardHolder Name:
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="col-span-12">
                        <label htmlFor="card1" className="ti-form-label">
                          Card number:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Expiry1" className="ti-form-label">
                          Expiry:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="cvv1" className="ti-form-label">
                          CVV:{" "}
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="text-center">
                      ...
                      <h4 className="text-xl font-semibold mb-1">
                        Hurray !..Your Payment is Successfull
                      </h4>
                    </div>
                  </div>
                </div>
                <div className="mt-5 sm:flex justify-between items-center gap-x-2">
                  ...
                  >
                    Next<i className="ri-arrow-right-s-line rtl:rotate-180"></i>
                  </button>
                  <button
                    type="button"
                    className="ti-btn me-2  ti-btn-primary-full disabled:opacity-50 disabled:pointer-events-none"
            ...
            <div data-hs-stepper='{"mode": "non-linear"}'>
              <ul className="relative sm:flex flex-row gap-x-2 sm:space-y-0 space-y-4">
                ...
                >
                  ...
                  <div className="hidden sm:block w-full h-px flex-1 bg-gray-200  dark:bg-light group-last:hidden hs-stepper-success:!bg-primary hs-stepper-completed:!bg-success"></div>
                </li>
                <li
                  className="flex items-center gap-x-2 shrink basis-0 flex-1 group"
                  data-hs-stepper-nav-item='{"index": 2}'
              ...
              <div className="mt-5 sm:mt-8">
                <div data-hs-stepper-content-item='{"index": 1}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Name2" className="ti-form-label">
                          Name:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Email2" className="ti-form-label">
                          Email:{" "}
                        </label>
                        <input
                          type="email"
                ...
                <div data-hs-stepper-content-item='{"index": 2}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Telephone2" className="ti-form-label">
                          Telephone:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Mobile3" className="ti-form-label">
                          Mobile:{" "}
                        </label>
                        <input
                          type="text"
                ...
                <div data-hs-stepper-content-item='{"index": 3}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                      <div className="col-span-12">
                        <label htmlFor="cardholder2" className="ti-form-label">
                          CardHolder Name:
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="col-span-12">
                        <label htmlFor="card2" className="ti-form-label">
                          Card number:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Expiry2" className="ti-form-label">
                          Expiry:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="cvv2" className="ti-form-label">
                          CVV:{" "}
                        </label>
                        <input
                          type="text"
                ...
                <div className="mt-5 sm:flex justify-between items-center gap-x-2">
                  ...
                  <button
                    type="button"
                    className="ti-btn me-2  ti-btn-primary-full disabled:opacity-50 disabled:pointer-events-none"
                    data-hs-stepper-complete-step-btn='{"completedText": "This step is completed"}'
                  >
                    Complete Step
                  </button>
                  <button
              ...
              <div className="mt-5 sm:mt-8">
                <div data-hs-stepper-content-item='{"index": 1}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Name5" className="ti-form-label">
                          Name:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Email5" className="ti-form-label">
                          Email:{" "}
                        </label>
                        <input
                          type="email"
                ...
                <div data-hs-stepper-content-item='{"index": 2}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Telephone5" className="ti-form-label">
                          Telephone:
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Mobile5" className="ti-form-label">
                          Mobile:{" "}
                        </label>
                        <input
                          type="text"
                ...
                >
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                      <div className="col-span-12">
                        <label htmlFor="cardholder5" className="ti-form-label">
                          CardHolder Name:
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="col-span-12">
                        <label htmlFor="card5" className="ti-form-label">
                          Card number:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Expiry5" className="ti-form-label">
                          Expiry:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="cvv5" className="ti-form-label">
                          CVV:{" "}
                        </label>
                        <input
                          type="text"
              ...
              <div className="mt-5 sm:mt-8">
                <div data-hs-stepper-content-item='{"index": 1}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Name3" className="ti-form-label">
                          Name:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Email3" className="ti-form-label">
                          Email:{" "}
                        </label>
                        <input
                          type="email"
                ...
                <div data-hs-stepper-content-item='{"index": 2}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Telephone3" className="ti-form-label">
                          Telephone:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Mobile1" className="ti-form-label">
                          Mobile:{" "}
                        </label>
                        <input
                          type="text"
                ...
                <div data-hs-stepper-content-item='{"index": 3}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                      <div className="col-span-12">
                        <label htmlFor="cardholder3" className="ti-form-label">
                          CardHolder Name:
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="col-span-12">
                        <label htmlFor="card3" className="ti-form-label">
                          Card number:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Expiry3" className="ti-form-label">
                          Expiry:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="cvv3" className="ti-form-label">
                          CVV:{" "}
                        </label>
                        <input
                          type="text"
                ...
                >
                  <span className="min-w-7 min-h-7 group inline-flex items-center text-xs align-middle focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
                    <span className="size-7 flex justify-center items-center flex-shrink-0 bg-gray-100 font-medium text-gray-800 rounded-full group-focus:bg-gray-200  dark:bg-light dark:text-white dark:group-focus:bg-gray-600 hs-stepper-active:!bg-primary hs-stepper-success:!bg-primary hs-stepper-completed:!bg-success hs-stepper-completed:group-focus:!bg-success hs-stepper-error:!bg-danger hs-stepper-active:text-white hs-stepper-success:text-white hs-stepper-processed:bg-white hs-stepper-processed:border hs-stepper-processed:border-gray-200 hs-stepper-processed:dark:border-white/10">
                      <span className="hs-stepper-success:hidden hs-stepper-completed:hidden hs-stepper-error:hidden hs-stepper-processed:hidden">
                        1
                      </span>
                      <svg
                        className="hidden flex-shrink-0 size-3 hs-stepper-success:block"
                      ...
                      <svg
                        className="hidden flex-shrink-0 size-3 hs-stepper-error:block"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
              ...
              <div className="mt-5 sm:mt-8">
                <div data-hs-stepper-content-item='{"index": 1}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Name4" className="ti-form-label">
                          Name:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Email4" className="ti-form-label">
                          Email:{" "}
                        </label>
                        <input
                          type="email"
                ...
                <div data-hs-stepper-content-item='{"index": 2}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Telephone4" className="ti-form-label">
                          Telephone:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Mobile4" className="ti-form-label">
                          Mobile:{" "}
                        </label>
                        <input
                          type="text"
                ...
                <div data-hs-stepper-content-item='{"index": 3}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                      <div className="col-span-12">
                        <label htmlFor="cardholder4" className="ti-form-label">
                          CardHolder Name:
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="col-span-12">
                        <label htmlFor="card4" className="ti-form-label">
                          Card number:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Expiry4" className="ti-form-label">
                          Expiry:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="cvv4" className="ti-form-label">
                          CVV:{" "}
                        </label>
                        <input
                          type="text"
              ...
              <div className="mt-5 sm:mt-8">
                <div data-hs-stepper-content-item='{"index": 1,"isCompleted": true}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Name6" className="ti-form-label">
                          Name:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Email6" className="ti-form-label">
                          Email:{" "}
                        </label>
                        <input
                          type="email"
                ...
                <div data-hs-stepper-content-item='{"index": 2,"isCompleted": true}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 space-y-2 sm:space-y-0">
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Telephone6" className="ti-form-label">
                          Telephone:
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Mobile6" className="ti-form-label">
                          Mobile:{" "}
                        </label>
                        <input
                          type="text"
                ...
                <div data-hs-stepper-content-item='{"index": 3,"isCompleted": true}'>
                  <div className="p-6 bg-gray-50  dark:bg-light border border-dashed border-gray-200 dark:border-white/10 rounded-xl">
                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                      ...
                      <div className="col-span-12">
                        <label htmlFor="card6" className="ti-form-label">
                          Card number:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="Expiry6" className="ti-form-label">
                          Expiry:{" "}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="lg:col-span-6 col-span-12">
                        <label htmlFor="cvv6" className="ti-form-label">
                          CVV:{" "}
                        </label>
                        <input
                          type="text"
                ...
                <div className="mt-5 sm:flex justify-between items-center gap-x-2">
                  <button
                    ...
                    style={{ display: "none" }}
                  >
                    <i className="ri-arrow-left-s-line rtl:rotate-180"></i> Back
                  </button>
                  <button
                    type="button"
                    className="ti-btn me-2  ti-btn-primary-full disabled:opacity-50 disabled:pointer-events-none"
