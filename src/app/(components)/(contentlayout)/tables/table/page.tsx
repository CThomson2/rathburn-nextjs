                ...
                <tbody>
                  {Table1data.map((idx) => (
                    ...
                    >
                      ...
                      <td>
                        <span
                          className={`badge bg-${idx.color} text-${idx.color1}`}
                        >
                          {idx.text}
                        </span>
                      </td>
                      ...
                      <td>
                        <div className="hstack gap-2 flex-wrap">
                          <Link
                            ...
                            href="#!"
                            scroll={false}
                            className="text-info text-[.875rem] leading-none me-1"
                          >
              ...
              <table className="table whitespace-nowrap min-w-full ">
                ...
                <tbody className="table-group-divider dark:border-defaultborder/10">
                  ...
                  <tr className="border-b border-defaultborder">
                    ...
                    <td>
                      <Link href="#!" scroll={false} className="text-danger">
                ...
                <tbody>
                  {Colortables.map((idx) => (
                    ...
                    >
                      ...
                      <td>{idx.name}</td>
                      <td>
                        <span className={`badge ${idx.class2}`}>Processed</span>
                      </td>
                      <td>{idx.quantity}</td>
                      <td>{idx.price}</td>
                    </tr>
