...
const Mailapp = () => {
  ...
  const Close = () => {
    const mailinformation = document.querySelector(
      ".mails-information"
    ) as HTMLDivElement;
    if (innerWidth <= 1399) {
    ...
    <Fragment>
      ...
      <div className="container-fluid">
        <div className="main-mail-container !p-2 gap-x-2 flex">
          <div
            className={`mail-navigation ${
              isMailNavigationVisible ? "!block" : ""
            } border dark:border-defaultborder/10`}
          >
                ...
                >
                  ...
                  <li>
                    <Link href="#!" scroll={false}>
                      <div className="flex items-center">
                        <span className="me-2 leading-none">
                          <i className="ri-price-tag-line align-middle text-[.875rem] font-semibold text-black dark:text-white"></i>
                        </span>
                        <span className="flex-grow whitespace-nowrap">
                          Friends
                        </span>
          ...
          <div
            className={`total-mails ${isTotalMailsVisible ? "!block" : ""} ${
              isTotalMailsHidden ? "!hidden" : ""
            } border dark:border-defaultborder/10`}
          >
          ...
          <div
            className={`mails-information ${
              isMailsInformationVisible ? "!block" : ""
            } border dark:border-defaultborder/10 text-defaulttextcolor text-defaultsize`}
          >
              ...
              <div className="mail-attachments mb-6">
                ...
                <div className="mt-2 flex items-center flex-wrap">
                  ...
                  <div className="hs-tooltip ti-main-tooltip">
                    <button
                      type="button"
                      className="hs-tooltip-toggle !w-[2.75rem] !h-[2.75rem] ti-btn-icon ti-btn-outline-light dark:hover:!bg-light 
