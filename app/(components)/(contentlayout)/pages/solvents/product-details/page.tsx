                        ...
                        <SwiperSlide id="img-container">
                          <img
                            className={
                              defaultData &&
                              defaultData.preview !=
                                "../../../assets/images/ecommerce/png/15.png"
                    ...
                    <div className="xl:col-span-8 col-span-12 xxl:mt-0 mt-4">
                      ...
                      <p className="text-[1.125rem] mb-4">
                        ...
                        <span className="font-semibold text-[#8c9097] dark:text-white/50 ms-1">
                          4.3
                          <Link className="text-info" href="#!" scroll={false}>
                            (2.4k Reviews)
                          </Link>
                        </span>
                      </p>
                      <div className="grid grid-cols-12 mb-6">
                        <div className="xxl:col-span-3 xl:col-span-12 col-span-12">
                          ...
                          <p className="mb-0 text-[#8c9097] dark:text-white/50 text-[0.75rem]">
                            M.R.P-<s>{defaultData && defaultData.newpr}</s>
                          </p>
                        </div>
