                    ...
                    >
                      <div className="flex mb-0">
                        ...
                        <div className="flex-grow">
                          ...
                          <span className="text-[#8c9097] dark:text-white/50 text-[0.75rem] !font-normal">
                    ...
                    >
                      <div className="accordion-body !pt-0 !ps-8">
                        <div className="text-[0.6875rem]">
                          ...
                          <span className="text-[#8c9097] dark:text-white/50 opacity-[0.5] ps-4 !font-normal">
