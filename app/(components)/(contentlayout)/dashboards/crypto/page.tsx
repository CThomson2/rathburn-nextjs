                ...
                <div className="box-body">
                  <div className="flex items-center mb-5">
                    ...
                    <div className="ms-auto">
                      <div id="btc-chart">
                        <ReactApexChart
                          options={Cryptodata.CryptoBTC.options}
                          series={Cryptodata.CryptoBTC.series}
                          type="line"
                          height={40}
                          width={120}
                        />
                ...
                <div className="box-body">
                  <div className="flex items-center mb-5">
                    ...
                    <div className="ms-auto">
                      <div id="eth-chart">
                        <ReactApexChart
                          options={Cryptodata.CryptoETH.options}
                          series={Cryptodata.CryptoETH.series}
                          type="line"
                          height={40}
                          width={120}
                        />
                ...
                <div className="box-body">
                  <div className="flex items-center mb-5">
                    ...
                    <div className="ms-auto">
                      <div id="dash-chart">
                        <ReactApexChart
                          options={Cryptodata.Cryptodash.options}
                          series={Cryptodata.Cryptodash.series}
                          type="line"
                          height={40}
                          width={120}
                        />
              ...
              <div className="box">
                ...
                <div className="box-body !p-0">
                  ...
                  <div id="crypto" className="p-4">
                    <ReactApexChart
                      options={Cryptodata.Statistics.options}
                      series={Cryptodata.Statistics.series}
                      type="candlestick"
                      width={"100%"}
                      height={258}
                    />
                      ...
                      <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                        ...
                        <td>
                          <div id="bitcoin-price-graph">
                            <ReactApexChart
                              options={Cryptodata.Cryptobitcoin.options}
                              series={Cryptodata.Cryptobitcoin.series}
                              type="line"
                              height={20}
                              width={120}
                            />
                      ...
                      <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                        ...
                        <td>
                          <div id="etherium-price-graph">
                            <ReactApexChart
                              options={Cryptodata.Cryptoetherium.options}
                              series={Cryptodata.Cryptoetherium.series}
                              type="line"
                              height={20}
                              width={120}
                            />
                      ...
                      <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                        ...
                        <td>
                          <div id="dash-price-graph">
                            <ReactApexChart
                              options={Cryptodata.Cryptodash1.options}
                              series={Cryptodata.Cryptodash1.series}
                              type="line"
                              height={20}
                              width={120}
                            />
                      ...
                      <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                        ...
                        <td>
                          <div id="ripple-price-graph">
                            <ReactApexChart
                              options={Cryptodata.Cryptoripple.options}
                              series={Cryptodata.Cryptoripple.series}
                              type="line"
                              height={20}
                              width={120}
                            />
                      ...
                      <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                        ...
                        <td>
                          <div id="iota-price-graph">
                            <ReactApexChart
                              options={Cryptodata.Cryptoiota.options}
                              series={Cryptodata.Cryptoiota.series}
                              type="line"
                              height={20}
                              width={120}
                            />
                      ...
                      <tr className="border border-inherit border-solid hover:bg-gray-100 dark:border-defaultborder/10 dark:hover:bg-light">
                        ...
                        <td>
                          <div id="neo-price-graph">
                            <ReactApexChart
                              options={Cryptodata.Cryptoneo.options}
                              series={Cryptodata.Cryptoneo.series}
                              type="line"
                              height={20}
                              width={120}
                            />
